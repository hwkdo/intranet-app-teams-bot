...
title('TeamsBot - Beispiel');

state(['exampleData' => [
    'name' => 'Beispiel Item',
    'description' => 'Dies ist ein Beispiel-Item für die TeamsBot App',
    'status' => 'active',
...
<div>
<x-intranet-app-teams-bot::teams-bot-layout heading="Beispiel-Seite" subheading="Demonstration der TeamsBot-Funktionalität">
    <flux:card>

...
namespace Hwkdo\IntranetAppTeamsBot\Http;
...
class TeamsSdkRestClient
{
    ...
    {
        $baseUrl = rtrim((string) config('intranet-app-teams-bot.sdk_rest.base_url', ''), '/');
    ...
    {
        $apiKey = config('intranet-app-teams-bot.sdk_rest.api_key');
        ...
        return Http::withToken($apiKey)
            ->timeout((int) config('intranet-app-teams-bot.sdk_rest.timeout', 30))
            ->acceptJson();
    }
